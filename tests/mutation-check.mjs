...
const mutations = [
  ...
  },
  {
    ...
    from: "  return fitPrompt(policyBlock(Math.floor(CFG.maxPromptChars * 0.6)), checkerActionBlock(plan, event, ctx));",
    to: "  return fitPrompt(\"\", checkerActionBlock(plan, event, ctx));",
  },
  {
  ...
  },
  {
    ...
    from: "  return (ACTION_RANK[scoped] ?? 0) < (ACTION_RANK[base] ?? 0) ? scoped : base;",
    to: "  return base;",
  },
  {
